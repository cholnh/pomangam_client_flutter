        ...
        children: <Widget>[
          Expanded(
            child: Padding(
              ...
              child: TextFormField(
                ...
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0, color: Theme.of(Get.context).primaryColor),
                inputFormatters: [
                ...
                decoration: InputDecoration(
                  ...
                  helperStyle: TextStyle(fontSize: 11.0, color: Colors.black.withOpacity(0.5)),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Center(
                  child: Text('사용', style: TextStyle(color: Theme.of(Get.context).backgroundColor, fontSize: 14.0))
              ),
            ),
          )
        ],
