                              ...
                              Row(
                                children: <Widget>[
                                  Text(
                                    '$title',
                                    style: TextStyle(
                                        color: !isUsed && isValid ? Theme.of(Get.context).primaryColor : Colors.black.withOpacity(0.5),
                                        fontWeight: FontWeight.bold,
                                        fontSize: 16.0),
                                  ),
                                  isNew ? Padding(padding: const EdgeInsets.only(right: 6.0)) : Container(),
                                  isNew ? Text('new', style: TextStyle(color: Theme.of(Get.context).primaryColor, fontSize: 11.0, fontWeight: FontWeight.bold)) : Container()
                                ],
                              ),
                              Padding(padding: const EdgeInsets.only(bottom: 5.0)),
                              Text(
                                '$subtitle',
                                style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 12.0),
                              ),
                              Text(
                                '$date',
                                style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 12.0),
